...
local PopularAnim_Button = Instance.new("TextButton")
...
PopularAnim_Button.Name = "PopularAnim_Button"
PopularAnim_Button.Parent = Animations_Section
PopularAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
PopularAnim_Button.BackgroundTransparency = 0.500
PopularAnim_Button.BorderColor3 = Color3.fromRGB(0, 0, 0)
PopularAnim_Button.BorderSizePixel = 0
PopularAnim_Button.Position = UDim2.new(0, 210, 0, 525)
PopularAnim_Button.Size = UDim2.new(0, 150, 0, 30)
PopularAnim_Button.Font = Enum.Font.Oswald
PopularAnim_Button.Text = "Popular"
PopularAnim_Button.TextColor3 = Color3.fromRGB(0, 0, 0)
PopularAnim_Button.TextScaled = true
PopularAnim_Button.TextSize = 14.000
PopularAnim_Button.TextWrapped = true
...
CreateClicker(PopularAnim_Button)
...
PopularAnim_Button.MouseButton1Click:Connect(function()
	local Animate = plr.Character.Animate
	Animate.Disabled = true
	StopAnim()
