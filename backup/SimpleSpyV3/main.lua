...
local Highlight = loadstring(game:HttpGet("https://raw.githubusercontent.com/MaliDevs/master/backup/SimpleSpyV3/highlight.lua"))() -- (isfile and loadfile and isfile("Highlight.lua") and loadfile("Highlight.lua")()) or loadstring(game:HttpGet("https://raw.githubusercontent.com/78n/SimpleSpy/main/Highlight.lua"))()
...
if not getgenv().SimpleSpyExecuted then
    local succeeded,err = pcall(function()
        ...
        logthread(spawn(function()
            local suc,err = pcall(game.HttpGet,game,"https://raw.githubusercontent.com/MaliDevs/master/backup/SimpleSpyV3/update.txt")
...
if configs.supersecretdevtoggle then
    ...
    function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/MaliDevs/master/backup/SimpleSpyV3/main.lua"))()
    end)
